...
class VideoGenerationResponseDTO(BaseModel):
    """DTO for video generation response."""
...
class VideoTaskStatusDTO(BaseModel):
    """DTO for video task status."""
...
class AdvancedVideoRequest(VideoGenerationRequestDTO):
    """Advanced video generation request with additional parameters."""
...
VideoGenerateRequest = VideoGenerationRequestDTO
VideoGenerateResponse = VideoGenerationResponseDTO
VideoTaskResponse = VideoTaskStatusDTO
